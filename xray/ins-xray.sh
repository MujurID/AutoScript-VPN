...
# Link Hosting Kalian
mujuridvpn="raw.githubusercontent.com/MujurID/AutoScript-VPN/main/ssh"
wget -q -O /etc/nginx/nginx.conf "https://${mujuridvpn}/v1.1/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://${mujuridvpn}/v1.1/vps.conf"
